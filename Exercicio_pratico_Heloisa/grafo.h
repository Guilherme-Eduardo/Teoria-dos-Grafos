...
/*Funcao wrapper para facilitar na chamada da funcao busca/remove chave*/
int vertice_id_(obj c);
int aresta_id_(obj c);

//int peso_aresta (aresta e);

char *atomo (vertice v);
...
/* Remove toda fronteira do vertice*/
void remove_fronteira (vertice v, grafo G);
...
//void adiciona_peso_aresta (lista arestas);
